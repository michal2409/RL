...
class MLPerfGRPOLogger:
    ...
    def log_hyperparams(
        ...
        validation_generation_cfg = grpo_cfg.get("validation_generation") or {}
        ...
        logging_configs = {
            ...
            "generation_validation_rollout_temperature": validation_generation_cfg.get("temperature"),
            "generation_validation_rollout_top_p": validation_generation_cfg.get("top_p"),
